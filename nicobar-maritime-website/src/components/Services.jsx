...
const Services = () => {
  return (
    <>
      <section id="services" className="bg-gray-2 pb-10  dark:bg-dark lg:pb-20 lg:pt-[20px] ">
        <div className="container"> <h1 className=" font-bold text-[#e8b641] flex items-center justify-center text-5xl mb-10 ">Services</h1>
          <div className="grid gap-2   sm:grid-cols-2 lg:grid-cols-4    bg-[#e8b641] rounded-xl shadow-lg  ">
