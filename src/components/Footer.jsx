...
const Footer = () => {
  return (
    <>
      <section id="contactus" className="relative z-10 overflow-hidden text-gray-100 bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] py-16 px-4 sm:px-6 md:px-8 lg:py-[90px]">
              ...
              <div className="mb-12 lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6 font-sans">
                      (+91) 9652442433, 7097863623
                    </p>
                  </div>
                </div>
